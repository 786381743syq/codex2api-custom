...
import { LayoutDashboard, Users, Activity, Settings, Server, Languages, Globe, BookOpen, KeyRound, Image as ImageIcon, ShieldAlert, ExternalLink, ChevronLeft, Palette, Sun, Moon, LogOut, Download, Loader2, Mail, Menu, RefreshCw, X } from 'lucide-react'
...
const navDefs: NavDef[] = [
  ...
  { to: '/contributions', labelKey: 'nav.contributions', icon: <Mail className="size-[18px]" /> },
